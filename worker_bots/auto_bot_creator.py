...
# ─────────────────────────────────────────────────────────────────────────────
ACCOUNTS = [
    {"label": "Akkaunt-1", "session_file": os.path.join(SCRIPT_DIR, "..", "sessionbase", "session_string.txt"),   "session_string": ""},
    {"label": "Akkaunt-2", "session_file": os.path.join(SCRIPT_DIR, "..", "sessionbase", "session_string_2.txt"), "session_string": ""},
    {"label": "Akkaunt-3", "session_file": os.path.join(SCRIPT_DIR, "..", "sessionbase", "session_string_3.txt"), "session_string": ""},
    # {"label": "Akkaunt-4", "session_file": os.path.join(SCRIPT_DIR, "..", "sessionbase", "session_string_4.txt"), "session_string": ""},
    # {"label": "Akkaunt-5", "session_file": os.path.join(SCRIPT_DIR, "..", "sessionbase", "session_string_5.txt"), "session_string": ""},
]
...
TOKENS_FILE           = os.path.join(SCRIPT_DIR, "created_tokens.txt")
